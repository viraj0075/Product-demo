  ...
  return (
    <>
        ...
        <div className="layout-container">
          <nav ref={navRef} className="w-full transition-all duration-300 bg-brand-surface/30 backdrop-blur-sm text-white border border-white/10 py-3 px-4 flex justify-between items-center rounded-2xl md:rounded-full">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
              ...
              <a href="#features" onClick={(e) => handleNavClick(e, '#features')} className="hover:text-brand-primary transition-colors">Features</a>
            ...
            <div className="hidden md:flex items-center gap-4">
              <button className="text-sm font-medium hover:text-white text-gray-300 transition-colors cursor-pointer">Log In</button>
              <button className="text-sm font-medium bg-brand-primary-dark hover:bg-purple-600 text-white px-5 py-2 rounded-full transition-all hover:scale-105 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] cursor-pointer">
                Get Started
              </button>
            </div>
      ...
      >
        ...
        <a href="#features" onClick={(e) => handleNavClick(e, '#features')} className="text-xl font-semibold text-gray-300 hover:text-white transition-colors">Features</a>
        ...
        <div className="flex flex-col w-full max-w-[260px] gap-3 mt-6">
          <button onClick={() => setIsMobileMenuOpen(false)} className="w-full text-base font-medium text-white bg-brand-primary-dark py-3 rounded-full shadow-[0_0_15px_rgba(168,85,247,0.4)] hover:bg-purple-600 transition-all hover:scale-105 curso r-pointer">
            Get Started
          </button>
          <button onClick={() => setIsMobileMenuOpen(false)} className="w-full text-base font-medium text-gray-300 hover:text-white py-3 border border-white/10 rounded-full hover:bg-white/5 transition-all cursor-pointer">
            Log In
          </button>
        </div>
      </div>
