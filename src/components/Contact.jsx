        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-[0_10px_40px_rgba(0,0,0,0.3)]">
          ...
          >
            ...
            <div className="form-field mt-2 sm:mt-4">
              <button className="w-full py-2.5 sm:py-3 rounded-lg sm:rounded-xl bg-brand-primary-dark text-white font-semibold text-sm sm:text-base hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 cursor-pointer">
                Send Message
              </button>
            </div>
