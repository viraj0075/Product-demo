    ...
    <footer ref={containerRef} className="relative py-12 overflow-hidden">
      ...
      <div className="layout-container relative z-10">
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-8 shadow-[0_20px_80px_rgba(0,0,0,0.4)]
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8 py-6">

            {/* Brand */}
            <div className="footer-col space-y-5 max-w-sm mx-auto lg:mx-0 lg:max-w-[260px] flex flex-col items-center lg:items-start">
            ...
            <div className='flex flex-col md:flex-row justify-center md:justify-end flex-wrap gap-10 lg:gap-16'>

              {/* Company */}
              <div className="footer-col space-y-4 flex flex-col items-center md:items-start">
              ...
              {/* Newsletter */}
              <div className="footer-col space-y-4 flex flex-col items-center md:items-start max-w-xs mx-auto md:mx-0">
                <h4 className="text-white text-sm font-semibold uppercase tracking-wider">
                  Stay Updated
                </h4>
                ...
                <div className="flex items-center bg-white/5 border border-white/10 rounded-full overflow-hidden w-full max-w-xs">
                  <input
                    ...
                    className="bg-transparent px-4 py-2 text-sm text-white outline-none w-full text-left"
                  />
